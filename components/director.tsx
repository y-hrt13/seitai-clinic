      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            福山市で通院が困難な方の為に《 出張整体 てのひら 》 を初めました。<br />
          <br />
          ...
          <br />
          定期的にイベントにも参加していますので、ご興味ありましたらご家族やお友達と一緒にご参加ください。</div>
          ...
          <div className="relative aspect-[4/5] overflow-hidden rounded-lg max-w-sm mx-auto md:max-w-md">
  <img
