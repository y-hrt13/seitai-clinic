    ...
    <section id="director" className="py-24 bg-background">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          《出張整体 てのひら》 を初めました。<br />
                肩こり・腰痛など現代人特有の症状に対して根本的な改善を目指した施術を提供しています。以前の勤務先では、主に産後の骨盤矯正やダイエットメニューを担当していましたので女性の方もお気軽にご相談下さい。
              <br />
              
                お1人おひとりの症状や生活習慣に合わせた、オーダーメイドの施術をご提案いたします。施術は痛みの少ないソフトな手技を中心に行います。
              <br />
